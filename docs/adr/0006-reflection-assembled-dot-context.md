...
- **Fixed context struct in xtemplate** (hard-coded fields). Rejected: every new provider would require a core API change, and user custom providers could not add fields without forking.
