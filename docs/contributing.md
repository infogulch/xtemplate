...
| Package | Description |
|---|---|
| `github.com/infogulch/xtemplate` | Core library: Server, Instance, controllers, providers |
| `./app/` | `app.Main`; configures and starts xtemplate from CLI args and JSON config |
| `./cmd/xtemplate/` | Standalone binary; blank-imports providers + controllers; calls `app.Main` |
| `./controllers/*/` | Optional template controllers (watchfs, git) |
...
- [`cmd/xtemplate/main.go`](/cmd/xtemplate/main.go) - Package main; blank-imports providers/controllers; calls `app.Main`
